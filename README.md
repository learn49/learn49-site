...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app app-7489
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app app-7489-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'app-7489-staging' does not match app name in config file 'app-7489'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name app-7489-db
  fly postgres attach --postgres-app app-7489-db --app app-7489

  fly postgres create --name app-7489-staging-db
  fly postgres attach --postgres-app app-7489-staging-db --app app-7489-staging
  ```
